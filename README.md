...
# \*DISCLAIMER: The packet generator being added soon is NOT a DDoS tool, it is a network stress tool, any activities/crimes commited with my tools I dont claim responsiblility for, DDoS'ing is a federal crime, Use my tools responsibly. I also take no responsibility if you get in trouble with your school, check your school's policies before using Tryn Services or trynProxy as it is illegal to evade school policies, this tool was made as a coding project, there is NO proof of me, or anyone I know using/interacting with my services on school Campus, any evidence must be backed by history, and net-foreinsics tools otherwise rendered not suitible.\*
